...
export const ToolPage: React.FC = () => {
  return (
    <motion.div 
      ...
      className="space-y-10 lg:space-y-0 lg:grid lg:grid-cols-12 lg:gap-12"
    >
      <div className="lg:col-span-7 space-y-8">
        {/* Hero Section */}
        <section className="space-y-4">
          <h2 className="text-3xl sm:text-5xl lg:text-6xl font-display font-black tracking-tighter text-on-surface leading-tight">
            REPURPOSE <br />
            <span className="text-primary italic">CONTENT</span>
          </h2>
          <p className="text-on-surface-variant text-xs sm:text-base font-medium tracking-wide max-w-[400px]">
            Transform your long-form videos into viral clips with AI precision. The future of content creation is here.
          </p>
        </section>
        ...
        <GlassCard className="p-6 sm:p-10">
          <div className="flex flex-col items-center text-center space-y-6">
            <div className="w-14 h-14 rounded-2xl bg-primary/20 backdrop-blur-md flex items-center justify-center border border-primary/30 glow-primary rotate-3">
              <Wand2 className="text-primary w-7 h-7" />
            </div>
            
            <div className="space-y-1">
              <h3 className="text-lg sm:text-2xl font-display font-bold">Select Video Source</h3>
            ...
            <div className="w-full space-y-4">
              <div className="relative group">
                <input 
                  ...
                  className="w-full bg-background/50 border border-outline/30 rounded-xl py-4 px-6 text-sm text-on-surface placeholder:text-on-surface-variant/40 focus:ring-2 focus:ring-primary/20 focus:border-primary/50 transition-all outline-none"
                />
              ...
              <CyberButton variant="primary" className="w-full py-3.5">
